...
- 基于 zospusher 提供的接口发送信息，Server酱说明：http://sc.ftqq.com/1.version
...
- tg 推送机器人已停运，请自建服务器
- zospusher 一对多好像也挂了，哪个大佬无聊可以弄一下 pushplus
- 基于斐讯 k3 制作，不同系统不同设备，可能会遇到各种问题
- 潘多拉系统、或不支持 sh 的系统，请将脚本开头 `#!/bin/sh` 改为 `#!/bin/bash`，或手动安装 `sh`

# Download
- [luci-app-zospusher](https://github.com/tty228/luci-app-zospusher/releases)
